...
export const API_URL_MERCADERIAS: string = API_URL_SERVER + API_NOMBRE + '/mercaderias';
export const API_URL_SUCURSALES: string = API_URL_SERVER + API_NOMBRE + '/sucursales';
export const API_URL_DPTOS_POLITICO: string = API_URL_SERVER + API_NOMBRE + '/departamentosPolitico';

export const API_URL_MUNICIPIOS: string = API_URL_SERVER + API_NOMBRE + '/municipios';
export const API_URL_MUNICIPIOS_POR_DPTO_POLITICO: string = API_URL_SERVER + API_NOMBRE + '/municipios' + '/filtrarPorDepartamentoPolitico';

export const API_URL_DEPARTAMENTOS: string = API_URL_SERVER + API_NOMBRE + '/departamentos';
export const API_URL_TIPOS_MOVIMIENTO: string = API_URL_SERVER + API_NOMBRE + '/tipos-movimiento';
export const API_URL_MOVIMIENTOS: string = API_URL_SERVER + API_NOMBRE + '/movimientos';
export const API_URL_MONEDAS: string = API_URL_SERVER + API_NOMBRE + '/monedas';
export const API_URL_ENTIDADES: string = API_URL_SERVER + API_NOMBRE + '/entidades';
export const API_URL_CUENTAS_CONTABLES: string = API_URL_SERVER + API_NOMBRE + '/cuentasContables';
